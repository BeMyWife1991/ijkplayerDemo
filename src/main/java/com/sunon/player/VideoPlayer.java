...
public class VideoPlayer {
    ...
    public VideoPlayer(final Activity activity) {
        try {
            ...
            Log.e("VideoPlayer", "loadLibraries error", e);
        }
...
//            videoView.toggleAspectRatio();
    ...
    public VideoPlayer onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public VideoPlayer live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }
    ...
    public VideoPlayer onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
